...
.locked					= "Û¯¸", // MaxLen: 15
.press_blue_plus_star			= "±µÎÞÀÝ + *", // MaxLen: 19
.to_unlock				= "Û¯¸¶²¼Þ®", // MaxLen: 19
.unlocked				= "Û¯¸¶²¼Þ®½Ð", // MaxLen: 15
.power_off				= "ÃÞÝ¹ÞÝ Off...", // MaxLen: 16
.error					= "´×-", // MaxLen: 8
.rx_only				= "¼Þ­¼ÝÉÐ", // MaxLen: 14
...
.all_channels				= "¾ÞÝ Á¬ÝÈÙ", // MaxLen: 16
...
.rx_group				= "RX¸ÞÙ-Ìß", // MaxLen: 16 (with ':' and codeplug group name)
...
.brightness_off				= "±¶Ù»»²Ã²", // MaxLen: 16 (with ':' + 0..100 + '%')
...
.contact_deleted			= "ºÝÀ¸¼Þ®É»¸¼Þ®½Ð", // MaxLen: 16
...
.low_battery				= "ÊÞ¯ÃØ-·ÞÚ !!!", // MaxLen: 16
.Auto					= "µ-Ä", // MaxLen 16 (with .mode + ':') 
.manual					= "ÏÆ­±Ù",  // MaxLen 16 (with .mode + ':')
.ptt_toggle				= "PTT Ä¸ÞÙ", // MaxLen 16 (with ':' + .on or .off)
.private_call_handling			= "Pº-Ù·®¶", // MaxLen 16 (with ':' + .on or .off)
.stop					= "½Ä¯Ìß", // Maxlen 16 (with ':' + .scan_mode/.dmr_beep)
.one_line				= "1 ·Þ®³Ò", // MaxLen 16 (with ':' + .contact)
.two_lines				= "2 ·Þ®³Ò", // MaxLen 16 (with ':' + .contact)
...
.audio_prompt				= "µÝ¾²ÌßÛÝÌßÄ",// Maxlen 16 (with ':' + .silent, .normal, .beep or .voice_prompt_level_1)
.silent                                 = "Å¼", // Maxlen 16 (with : + audio_prompt)
.normal                                 = "Â³¼Þ®³", // Maxlen 16 (with : + audio_prompt)
.beep					= "ËÞ-Ìß", // Maxlen 16 (with : + audio_prompt)
.voice_prompt_level_1			= "µÝØ®³ÚÍÞÙ", // Maxlen 16 (with : + audio_prompt)
...
.channel_power				= "Ch Pwr", //Displayed as "Ch Power:" + .channel_power_from_master or "Ch Power:"+ power text e.g. "Power:500mW" . Max total length 16
.channel_power_from_master		= "Ï½À-",// Displayed if per-channel power is not enabled  the .channel_power
...
.vfo_freq_bind_mode			= "¼­³Ê½³ bind",
.overwrite_qm				= "³Ü¶Þ·OK?" //Maxlen: 14 chars
};
/********************************************************************
 *
 * VERY IMPORTANT.
