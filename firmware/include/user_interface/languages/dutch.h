...
.options					= "Opties", // MaxLen: 16
.display_options			= "Scherm opties", // MaxLen: 16
.sound_options				= "Geluid opties", // MaxLen: 16
.channel_details			= "Kanaal details", // MaxLen: 16
.language					= "Taal", // MaxLen: 16
.new_contact				= "Nieuw contact", // MaxLen: 16
.contact_list				= "Contactlijst", // MaxLen: 16
...
.voice_prompt_level_1		= "Stem", // Maxlen 16 (with : + audio_prompt)
.transmitTalkerAlias		= "TA zenden ", // Maxlen 16 (with : + .on or .off)
.squelch_VHF				= "VHF Squelch",// Maxlen 16 (with : + XX%)
.squelch_220				= "220 Squelch",// Maxlen 16 (with : + XX%)
.squelch_UHF				= "UHF Squelch", // Maxlen 16 (with : + XX%)
.display_background_colour	= "Kleur  ", // Maxlen 16 (with : + .colour_normal or .colour_invert)
...
.dtmf_contact_list			= "DTMF lijst", // Maxlen: 16
.channel_power				= "Kn kracht", //Displayed as "Ch Power:" + .channel_power_from_master or "Ch Power:"+ power text e.g. "Power:500mW" . Max total length 16
