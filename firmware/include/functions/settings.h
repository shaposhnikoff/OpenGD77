...
typedef enum PROMPT_AUTOPLAY_THRESHOLD { PROMPT_THRESHOLD_1 = AUDIO_PROMPT_MODE_VOICE_LEVEL_1,PROMPT_THRESHOLD_2,PROMPT_THRESHOLD_3,PROMPT_THRESHOLD_4} audioPromptThreshold_t;
